...

{
    ...
    */
    ...
    face_cascade_name = "usr/local/share/opencv4/haarcascades/haarcascade_frontalface_default.xml";
    eyes_cascade_name = "usr/local/share/opencv4/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
